package com.github.generator.common.interceptor;

import com.github.generator.common.entity.Page;
import com.github.generator.common.utils.Reflections;
...
public class PageInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (parameter instanceof Page && ((Page) parameter).getPageNo() > 0) {
            //开始分页
            ...
            //总记录数小于分页数
            boolean flag = page.getCount() > (page.getPageNo() - 1) * page.getPageSize();
            if (!flag) {
